...
const WineCork = require('../assets/imgs/winecork.jpg')
const Vineyard = require('../assets/imgs/vineyard.jpg')
const CardFront = require('../assets/imgs/card-front.png')
const CardBack = require('../assets/imgs/card-back.png')
